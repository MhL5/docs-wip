...
latest zod version includes file validation this is for older versions
...
## email gen using react

[email generation template using react](https://react.email/?ref=jonas.io)
...
**Based on Shadcn but written with Panda CSS:**

- [Shadow Panda](https://shadow-panda.dev/)

**Like to Test:**

- [NextUI User Component](https://nextui.org/docs/components/user)
...
### Library for Creating Email Templates Using React

- [React Email Templates (ConvertKit)](https://click.convertkit-mail.com/xmuoozo2o7f6hr0qr9es5h03owzll/reh8hoh0nmvv02u2/aHR0cHM6Ly9yZWFjdC5lbWFpbC8_cmVmPWpvbmFzLmlv)

### SEO Performance

- [Next.js Lighthouse – unlighthouse.dev](https://next.unlighthouse.dev/)

## youtube watch list

https://youtu.be/yoiBv0K6_1U?si=hBw2UrO3Z9T288pJ
https://youtu.be/xyxrB2Aa7KE?si=y7xHzutOYwSwnGVb
https://youtu.be/b7uUWoS1Zro?si=pHa_iIW-r_2M7cU-
